...
class FlightHomePage(BasePage):
    def select_from_city(self, city_query: str, city_full_name: str):
        self.click((By.CSS_SELECTOR, "label[for='fromCity']"))
    ...
    def select_to_city(self, city_query: str, city_full_name: str):
        self.click((By.CSS_SELECTOR, "label[for='toCity']"))
    ...
    def select_date(self, date_select: str, return_date: str):

        self._select_single_date(date_select)
        self.click((By.XPATH,"//div[contains(@class,'reDates')]"))
    ...
    def numb_travellers_class(self, adults: int,  numb_kids: int, numb_infants: int, travellers_class: int):
        ...
        self.click((By.XPATH, "//label[@for='travellers']"))
        print("Travellers tab clicked.")
        # ---------Number of Adults Travellers 12+ age-----------
        self.click((By.CSS_SELECTOR, f"li[data-cy='adults-{adults}']"))
        if adults == 1:
        ...
        self.click((By.CSS_SELECTOR, f"li[data-cy='children-{numb_kids}']"))
        if numb_kids == 1:
        ...
        self.click((By.CSS_SELECTOR, f"li[data-cy='infants-{numb_infants}']"))
        if numb_infants == 1:
        ...
        # ---------Select class-----------
        self.click((By.CSS_SELECTOR, f"li[data-cy='travelClass-{travellers_class}']"))
        print(f"Selected {travellers_class} class.")

        #----------Apply Button-----------
        self.click((By.XPATH, "//button[normalize-space()='APPLY']"))
        # self.driver.execute_script("arguments[0].scrollIntoView({block: '700'});", apply_btn)
        # self.driver.execute_script("arguments[0].click();", apply_btn)
        print("apply button clicked")

    def search_button(self):
        self.click((By.CSS_SELECTOR, ".primaryBtn.font24.latoBold.widgetSearchBtn"))
